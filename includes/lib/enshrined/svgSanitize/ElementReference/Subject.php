<?php
namespace Eighteen73\Orbit\Dependencies\enshrined\svgSanitize\ElementReference;
...
class Subject
{
     ...
     * @return bool
     * @throws \Eighteen73\Orbit\Dependencies\enshrined\svgSanitize\Exceptions\NestingException
     */
    public function hasInfiniteLoop(array $subjects = [], $level = 1)
    {
        if ($level > $this->useNestingLimit) {
            throw new \Eighteen73\Orbit\Dependencies\enshrined\svgSanitize\Exceptions\NestingException('Nesting level too high, aborting', 1570713498, null, $this->getElement());
        }
